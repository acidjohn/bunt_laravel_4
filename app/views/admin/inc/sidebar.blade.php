			...
			<ul class="page-sidebar-menu">
				...
				<li class="start active ">
				 ...
				 <li class="has-sub ">
					...
					<ul class="sub-menu">
						<li ><a href="{{URL::action('Admin_BandsController@getAdd')}}">Add</a></li>
						<li ><a href="{{URL::action('Admin_BandsController@getView')}}">View/Edit</a></li>
				...
				<li class="has-sub ">
					...
					<span class="title">Bunticles</span>
					<span class="arrow "></span>
					</a>
					<ul class="sub-menu">
						<li ><a href="#">Add</a></li>
